                                        ...
                                        <div class="card shadow mb-3">
                                            ...
                                            <div class="card-body">
                                                <form>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col">
                                                            <div class="form-group"><label for="first_name"><strong>2. Lorem Ipsum is simply dummy text of the printing and typesetting industry ......</strong><br></label><input class="form-control" type="text" placeholder="John" name="first_name" style="width: 613px;"></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="col">
                                                            ...
                                                            <div class="form-group" style="margin-left: 19px;"><input type="radio"><label for="first_name" style="margin-right: 22px;"><strong>&nbsp;Lorem Ipsum</strong><br></label><input type="radio"><label for="first_name" style="margin-right: 22px;"><strong>&nbsp;Lorem Ipsum</strong><br></label>
                                                                <input type="radio"><label for="first_name" style="margin-right: 22px;"><strong>&nbsp;Lorem Ipsum</strong><br></label></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="col">
