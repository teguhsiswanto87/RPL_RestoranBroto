...
if (empty($_SESSION['nip']) && empty($_SESSION['password'])) {
    ...
    include_once "model/detail-pesanan.php";
    $menu = new Menu();
    $pesanan = new Pesanan();
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <h3 class="text-dark mb-4">
                            <a class="btn btn-secondary btn-sm" role="button" style="margin-right: 2rem;width: 100px; color: #fafafa; cursor: pointer;" onclick="self.history.back()">
                                        ...
                                        <div class="card shadow mb-3">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form method="POST" action="action/action_resep.php?act=tambah">
                                                    <input type="hidden" value="<?php echo "$dpesanan[no_pesanan]"; ?>" name="no_pesanan">
                                                    <div class="form-row">
                                                        <div class="col">
                                                            <div class="form-group"><label for="fakeNamaMenu"><strong>No
                                                                        Pesanan</strong></label>
                                                                <input class="form-control" type="text" value="<?php echo "$dpesanan[no_pesanan]"; ?>" placeholder="no pesanan" name="fakeNamaMenu" style="width: 270px;" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="col">
                                                            <div class="form-group" style="width: 280px;"><label for="bahan_baku"><strong>Nama
                                                                        Pemesan</strong></label>
                                                                <input class="form-control" type="text" value="<?php echo "$dpesanan[nama_pelanggan]"; ?>" placeholder="nama pesanan" name="fakeNamaMenu" style="width: 270px;" disabled>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col">
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $dataDpesanan = $DetailPesanan->getListPesanan("where no_pesanan='$_GET[id]'");
