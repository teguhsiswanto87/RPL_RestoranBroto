                            ...
                            <div class="col" style="width: 920px;">
                                <div class="card shadow mb-3">
                                    <div class="card-header py-3">
                                        <p class="text-primary m-0 font-weight-bold">Nama Menu</p>
                                    </div>
                                    <div class="card-body">
                                        <form>
                                            <div class="form-row">
                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="form-group"><a class="btn btn-primary btn-sm" role="button" style="margin-left: 721px;width: 118px;" href="daftar-menu.php">Kembali</a></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
